...
contract DeployerSignatureMinter is Script {
    ...
    function run() external {
        ...
        ERC721OviatorsExchangeSwapMinter swapMinter = new ERC721OviatorsExchangeSwapMinter({
        ...
        // 6 exchange disco token with OviatorsExchangeMinterModule to DISCO_VISION_REDEEMED
